  ...
  return (
    <div className="flex justify-end mb-4">
      <button
        ...
        className="text-sm md:text-base border border-primary hover:text-white hover:bg-[#ff6633] hover:border-transparent active:shadow-(--shadow-button-active) w-2/3 h-10 rounded p-2 justify-center items-center text-primary duration-300 cursor-pointer select-none"
      >

...
const PriceAlertEmail = (props: PriceAlertEmailProps) => {
  const { productTitle, oldPrice, newPrice, productUrl, unsubscribeUrl } = props;
          ...
          <Container className="bg-white rounded-none p-0 max-w-[600px] mx-auto">
            ...
            <Section className="px-8 py-8">
                ...
                <Section className="space-y-3">
                  <Row>
                    <Column className="w-1/2">
                      <Text className="text-[#414141] text-base mb-0">Старая цена:</Text>
                    </Column>
                  ...
                  <Row>
                    <Column className="w-1/2">
                      <Text className="text-[#414141] text-base mb-0">Новая цена:</Text>
                    </Column>
                    <Column className="w-1/2 text-right">
                  ...
                  <Row>
                    <Column className="w-1/2">
                      <Text className="text-[#414141] text-base mb-0">Ваша экономия:</Text>
                    </Column>
                    <Column className="w-1/2 text-right">
              ...
              <Section className="text-center">
                <Text className="text-[#666666] text-sm mb-4 leading-5">
                  Это письмо отправлено автоматически, потому что Вы подписались<br />
            ...
            <Section className="bg-[#f8f8f8] py-6 px-8 border-t border-[#e0e0e0]">
              <Text className="text-[#999999] text-xs text-center leading-4 mb-2">
                Северяночка<br />
                Россия, Архангельск, ул. Ленина, д.1<br />
                ИНН 0291234567890
              </Text>

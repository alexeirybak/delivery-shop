...
const PriceFilter = ({
  ...
  return (
    ...
    >
      ...
      <button
        type="submit"
        className="bg-[#ff6633] text-white hover:shadow-(--shadow-article) active:shadow-button-active h-10 rounded justify-center items-center transition-custom cursor-pointer"
      >
        Применить
      </button>
    </form>

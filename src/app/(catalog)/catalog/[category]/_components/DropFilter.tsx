  ...
  return (
    <div className="xl:hidden">
      <button
        ...
        className="ml-3 xl:hidden h-8 p-2 w-32 rounded text-xs flex justify-center items-center duration-300 gap-x-2 bg-primary text-white hover:shadow-button-default active:shadow-button-active cursor-pointer"
      >
        Фильтр
      </button>
      <div
        className={`xl:hidden flex flex-col gap-y-10
          fixed top-0 left-0 h-screen w-full max-w-90 bg-white z-50 p-4 overflow-y-auto shadow-article text-main-text

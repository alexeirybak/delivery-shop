  ...
  return (
    <div className="flex flex-row justify-between items-center">
      ...
      <button
        ...
        className="text-xs rounded bg-[#f3f2f1] h-8 p-2 cursor-pointer  hover:bg-primary hover:shadow-button-default hover:text-white active:shadow-button-active duration-300"
      >
        Очистить
      </button>
    </div>

...
export const CommentRow = ({
  ...
  return (
    <>
      <div className="grid md:grid-cols-[48px_75px_140px_100px_80px_100px] lg:grid-cols-[48px_120px_300px_120px_80px_120px] xl:grid-cols-[48px_160px_300px_150px_200px_140px] gap-2 lg:gap-4 px-2 py-3 items-center justify-center md:justify-between">
        ...
        >
          {comment.authorName}
          {isBanned && (
            <p className="ml-2 text-xs text-red-600">(заблокирован)</p>
          )}
        </button>

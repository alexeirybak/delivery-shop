    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
      <div>
        ...
        <input
          ...
          className="w-full px-3 py-2.5 border border-gray-300 rounded focus:outline-none focus:ring-3 focus:ring-primary/20 focus:border-primary duration-300 disabled:opacity-50 disabled:bg-gray-100 placeholder:text-gray-400"
      ...
      <div>
        ...
        <div className="flex flex-wrap gap-2">
          <input
            ...
            required
            disabled={isSubmitting}
            className="flex-1 px-3 py-2.5 border border-gray-300 rounded focus:outline-none focus:ring-3 focus:ring-primary/20 focus:border-primary duration-300 disabled:opacity-50 disabled:bg-gray-100 placeholder:text-gray-400"
            placeholder="soki"
          />
          <button
            type="button"
            ...
            disabled={isSubmitting}
            className="flex flex-1 items-center gap-1 px-4 py-2.5 bg-gray-50 text-gray-700 rounded hover:bg-gray-100 text-sm whitespace-nowrap cursor-pointer duration-200 disabled:opacity-50 disabled:cursor-not-allowed border border-gray-300 hover:border-gray-400 focus:outline-none focus:ring-2 focus:ring-gray-200 focus:border-gray-400"
      ...
      <div className="md:col-span-2">
        ...
        <textarea
          ...
          rows={3}
          disabled={isSubmitting}
          className="w-full px-3 py-2.5 border border-gray-300 rounded focus:outline-none focus:ring-3 focus:ring-primary/20 focus:border-primary duration-300 resize-none disabled:opacity-50 disabled:bg-gray-100 placeholder:text-gray-400"
          placeholder="Краткое описание статьи для поисковых систем (10-160 символов)"
        />
        <p className="text-xs text-gray-500 mt-1">

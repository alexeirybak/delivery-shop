...
export const BgColorMenu = ({ editor }: EditorProps) => {
  ...
  // Проверяем, поддерживает ли редактор команды для фона
  const canUnsetBackgroundColor = editor ? editor.can().chain().focus().unsetBackgroundColor().run() : false;

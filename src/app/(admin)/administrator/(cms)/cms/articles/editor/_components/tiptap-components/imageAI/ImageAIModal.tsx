          ...
          <div className="mb-6">
            ...
            <div className="mt-3 p-3 bg-gray-50 rounded-lg">
              ...
              <ul className="text-xs text-gray-600 space-y-1">
                <li>• Аппетитная пицца с расплавленным сыром, макросъемка</li>
                <li>
                  • Свежие фрукты на деревянном столе, естественное освещение
                </li>
                <li>• Ароматный кофе с пенкой, минималистичный стиль</li>
                <li>• Сочный стейк с овощами гриль, фотореалистично</li>
                <li>• Красочный салат в стеклянной миске, яркие цвета</li>
                <li>• Домашняя выпечка с корицей, уютная атмосфера</li>
                <li>• Мороженое с ягодами, летнее настроение</li>
                <li>• Суши на черной тарелке, элегантная подача</li>
              </ul>
            </div>
          </div>

...
export const TableHeader = () => {
  ...
  return (
    <div className="hidden lg:block">
      <div
        className="grid lg:grid-cols-[32px_56px_100px_100px_100px_56px_128px_80px_80px_40px_100px]  xl:grid-cols-[32px_56px_170px_150px_150px_56px_128px_100px_120px_50px_100px] gap-2 px-4 py-4 bg-gray-50 border-b border-gray-200 text-xs font-medium text-gray-500 uppercase tracking-wider items-center justify-between"
      >
        <div></div>
        <div
        ...
        <div
          className="cursor-pointer hover:text-gray-700 flex items-center justify-center"
        ...
        <div
          className="cursor-pointer text-center hover:text-gray-700 flex items-center justify-center"

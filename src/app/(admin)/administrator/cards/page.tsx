...
import { ItemsPerPageSelector } from "../(cms)/cms/_components/ItemsPerPageSelector";
...
const CardsPage = () => {
  ...
  }, [currentPage, currentFilter, searchCardNumber, searchOwner, itemsPerPage, loadCards]);
  ...
  const handleDelete = async (card: Card) => {
    ...
    try {
      const response = await fetch(`/api/admin/cards?cardNumber=${card.cardNumber}`, {
        method: "DELETE",
      });

    ...
    <section className="md:mx-4 xl:mx-12 text-main-text">
      ...
      <div className="flex flex-col md:flex-row justify-center gap-x-18">
        ...
        <div className="relative">
          <div className="px-10 py-5 lg:py-7.5 w-[290px] md:w-auto h-[82px] md:h-auto md:max-w-[351px] lg:max-w-[805px] text-primary font-bold bg-[#e5ffde] rounded-lg flex items-center text-center mx-auto">
          ...
          <Image
            ...
            className="absolute right-1/2 md:top-6 md:-left-10 md:-rotate-90"
          />
        </div>
      </div>
    </section>

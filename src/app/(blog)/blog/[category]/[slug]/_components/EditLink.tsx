  ...
  return (
    <div className="fixed top-6 right-6 z-50">
      ...
      >
        ...
        <div className="relative w-10 h-10 bg-white rounded-full flex items-center justify-center shadow-md group-hover:shadow-lg border border-gray-200 group-hover:border-green-300  transition-custom">
          <Edit className="w-5 h-5 text-green-600 group-hover:text-green-700 " />
        </div>
      </Link>
    </div>
  );

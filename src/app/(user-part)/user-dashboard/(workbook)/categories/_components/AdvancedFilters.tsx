  ...
  return (
    <div className="advanced-filters">
      <div className="advanced-filters-grid">
        <div>
          <label className="advanced-filters-label">Искать в:</label>
          <select
            value={filterType}
        ...
        <div>
          <label className="advanced-filters-label">Сортировать по:</label>
          <select
            value={sortField}
        ...
        <div>
          <label className="advanced-filters-label">Порядок сортировки:</label>
          <div className="advanced-filters-buttons">
            <button
              onClick={() => handleSortDirectionChange("asc")}
              className={`advanced-filters-btn ${
                sortDirection === "asc" ? "advanced-filters-btn-active" : ""
              }`}
            >
              По возрастанию
            </button>
            <button
              ...
              className={`advanced-filters-btn ${
                sortDirection === "desc" ? "advanced-filters-btn-active" : ""
              }`}
            >
              По убыванию
            </button>

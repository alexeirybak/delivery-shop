  ...
  return (
    <div className="download-panel-content">
      ...
      <p className="download-notice">
        Внимание! Из-за особенностей работы системы скачивание в формате Word
        может привести к некорректному отображению формул. Рекомендуем скачать
        документ сначала в формате PDF, а затем преобразовать в Word на внешних
        ресурсах.
      </p>

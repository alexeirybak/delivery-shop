      ...
      <div className="flex justify-between items-start">
        <div className="flex-1">
          ...
          <p className="text-yellow-700 text-sm mb-2">
            С момента предыдущего заказа произошли изменения. Заказ будет создан по актуальным ценам и скидкам.
          </p>
          ...
          <div className="mt-3 p-2 bg-yellow-100 rounded">
            <p className="text-yellow-800 font-medium text-sm">
              <span className="block">
                Сумма в предыдущем заказе: {formatPrice(priceComparison.originalTotal)} ₽
              </span>
              <span className="block">
                Сумма по актуальным ценам: {formatPrice(priceComparison.currentTotal)} ₽
              </span>
              {priceComparison.difference !== 0 && (
                <span
                  className={`block ${
                    priceComparison.difference > 0 ? "text-red-600" : "text-green-600"
                  }`}
                >

    ...
    try {
      ...
      switch (simulatedResult) {
        case "success":
          ...
          break;
        case "failure":
          // Для "Недостаточно средств" вызываем onError
          onError(
            'Недостаточно средств на карте. Повторную попытку оплаты Вы можете совершить на странице "Заказы". '
          );
          break;
        case "error":
          // Для "Ошибки банка" вызываем onError
          onError(
            'Ошибка банка-эмитента. Попробуйте позже. Повторную попытку оплаты Вы можете совершить на странице "Заказы". '
          );
          break;
      }
    } catch (error) {

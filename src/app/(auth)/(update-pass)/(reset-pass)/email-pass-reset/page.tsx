    ...
    <AuthFormLayout>
      ...
      >
        ...
        <button
          type="submit"
          disabled={loading}
          className={`text-white bg-primary hover:shadow-button-default active:shadow-button-active w-full max-w-65 mx-auto p-2 gap-4 cursor-pointer transition-custom rounded ${loading ? "bg-[#e5ffde]" : "bg-primary"}`}
        >

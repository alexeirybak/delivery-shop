    ...
    <div className="fixed inset-0 bg-[#fbf8ec] flex items-center justify-center z-50">
      <div className="bg-white rounded p-6 w-96">
        ...
        <div className="flex justify-end gap-3">
          <button
            onClick={onClose}
            className="flex-1 bg-[#f3f2f1] border-none rounded flex hover:shadow-button-secondary p-2 justify-center items-center active:shadow-button-active duration-300 cursor-pointer"
          >
            Отмена
          </button>
          <button

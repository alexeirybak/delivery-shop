    ...
    <div className="relative flex items-center justify-center min-h-screen overflow-hidden bg-linear-to-br from-purple-900 via-black to-blue-900">
      ...
      >
        ...
        >
          <Link
            href="/"
            className="relative inline-flex items-center justify-center px-8 py-4 overflow-hidden text-lg font-bold text-white transition-all duration-300 rounded-full shadow-2xl group bg-linear-to-r from-purple-600 to-pink-600 hover:shadow-purple-500/50"
          >
            <motion.span

...
const IconBox = () => {
  ...
  const fillColor = user?.role === "manager" || user?.role === "admin" 
    ? "rgb(255,102,51)" 
    : "rgb(65,65,65)"; 
  ...
  return (
    ...
    >
      ...
      <path
        id="Shape (Stroke)"
        d="M9.0529 3.27638C9.17639 3.02939 9.47673 2.92928 9.72372 3.05277L19.7237 8.05277C19.9707 8.17627 20.0708 8.4766 19.9473 8.72359C19.8238 8.97058 19.5235 9.0707 19.2765 8.9472L9.2765 3.9472C9.02951 3.82371 8.92940 3.52337 9.0529 3.27638Z"
        fill={fillColor}
      />
    </svg>
  );
